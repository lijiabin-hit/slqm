...
export default class MyCollection extends Component {
    ...
    componentDidMount=function(){
        ...
        console.log(`${WEBSITEURL}/CollectionShareList.php?id=0`)
        console.log(`${WEBSITEURL}/CollectionRecordList.php?id=0`)
        fetch(`${WEBSITEURL}/CollectionShareList.php?id=0&uID=${JSON.stringify(this.props.navigation.getParam('uID',"1"))}`)
        ...
        fetch(`${WEBSITEURL}/CollectionRecordList.php?id=0&uID=${JSON.stringify(this.props.navigation.getParam('uID',"1"))}`)
            .then((response)=>response.json())
            .then((responseJson)=>{
    ...
    static navigationOptions =({ navigation, navigationOptions }) =>{
        return {
            headerTitle: (<LogoTitle title="我的收藏"/>),
            headerLeft: (
                            ...
                            <RefreshableFlatList
                                ...
                                onLoadMore={() => new Promise((r) => {
                                    setTimeout(() => {
                                        ...
                                        fetch(`${WEBSITEURL}/CollectionShareList.php?id=${no}&uID=${JSON.stringify(this.props.navigation.getParam('uID',"1"))}`)
                                            .then((response)=>response.json())
                                            .then((responseJson)=>{
                            ...
                            <RefreshableFlatList
                                ...
                                onLoadMore={() => new Promise((r) => {
                                    setTimeout(() => {
                                        ...
                                        console.log()
                                        fetch(`${WEBSITEURL}/CollectionRecordList.php?id=${no}&uID=${JSON.stringify(this.props.navigation.getParam('uID',"1"))}`)
                                            .then((response)=>response.json())
                                            .then((responseJson)=>{
