...
class SearchList extends Component{
    ...
    componentDidMount=function(){
        console.log(`${WEBSITEURL}/SearchCircleList.php?id=0&content=${this.props.content}`);
        fetch(`${WEBSITEURL}/SearchCircleList.php?id=0&content=${this.props.content}`)
                ...
                <RefreshableFlatList
                    ...
                    onLoadMore={() => new Promise((r) => {
                        setTimeout(() => {
                            ...
                            console.log(`${WEBSITEURL}/SearchCircleList.php?id=${no}&content=${this.props.content}`);
                            fetch(`${WEBSITEURL}/SearchCircleList.php?id=${no}&content=${this.props.content}`)
                                .then((response)=>response.json())
                                .then((responseJson)=>{
...
export default class CircleSearch extends Component {
    state={
        content:""
    }
