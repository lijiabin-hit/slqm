...
export default class ShareList extends Component {
    ...
    componentDidMount=function(){
        fetch(`${WEBSITEURL}/shareList.php?id=0&cID=0`)
    ...
    static navigationOptions =({ navigation, navigationOptions }) =>{
        return {
            headerTitle: (<LogoTitle title="分&nbsp;&nbsp;享"/>),
            headerLeft: (
            ...
            headerRight: (
                ...
                <View style={{flexDirection:"row"}}>
                    <TouchableOpacity onPress={()=>navigation.navigate('ShareSearch',{content:""})}><Text><Icon name="md-search" size={23} color="white"/>&nbsp;&nbsp;&nbsp;&nbsp;</Text></TouchableOpacity>
                ...
                <RefreshableFlatList
                    ...
                    onLoadMore={() => new Promise((r) => {
                        setTimeout(() => {
                            ...
                            fetch(`${WEBSITEURL}/shareList.php?id=${no}&cID=0`)
                                .then((response)=>response.json())
                                .then((responseJson)=>{
